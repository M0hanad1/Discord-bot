...
class Mods:
    ...
    async def create_temp_channel(self, member: discord.Member, channel: discord.VoiceChannel, mood: bool):
        ...
        if not mood and temp_channel.category.voice_channels and channel in temp_channel.category.voice_channels and channel.id != temp and (not channel.members or len(channel.members) == 0):
